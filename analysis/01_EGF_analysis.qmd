...
write_tsv(logdata, file.path(output_dir, "logdata.tsv"))
```
...
# Save data
write_tsv(limma_results, file.path(output_dir, "limma_results.tsv"))
...
# Save data
write_tsv(ptm_all, file.path(output_dir, "ptmsea_results.tsv"))
